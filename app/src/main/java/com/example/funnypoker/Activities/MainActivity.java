...
import com.example.funnypoker.Util.RankEvaluator;
import com.example.funnypoker.View.CardView;
...
public class MainActivity extends AppCompatActivity implements Observer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        overridePendingTransition(R.anim.bounce, R.anim.downtoup);
        ...
        dealer = new Dealer("Opponent", this);
